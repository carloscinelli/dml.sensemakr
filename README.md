...
``` r
# sensitivity analysis with benchmark covariates
...
#> 
#> -- gain.Y: the observed strength of association of the benchmark covariate with the outcome.
#> -- gain.D: the observed strength of association of the benchmark covariate with the RR.
#> -- delta: the bias of omitting the benchmark covariate (i.e., theta.sj - theta.s).
#> 
