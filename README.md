...
#>  Model: Nonparametric 
#>  Cross-Fitting: 5 folds, 1 reps 
#>  ML Method: outcome (yreg0:ranger, yreg1:ranger, R2 = 26.611%), treatment (ranger, R2 = 11.401%)
#>  Tuning: dirty 
#> 
#> Average Treatment Effect: 
#> 
#>         Estimate Std. Error t value  P(>|t|)    
#> ate.all     8214       1160   7.081 1.43e-12 ***
#> ---
...
Benchmark covariates can be used to assess the plausible strength of
omitted variables:

``` r
# sensitivity analysis with benchmarks
sens.bench <- sensemakr(dml.401k,
                        benchmark_covariates = c("inc", "age", "educ", "marr"))

# contour plot with benchmark overlay
plot(sens.bench)
```

<img src="man/figures/README-benchmarks-1.png" width="100%" style="display: block; margin: auto;" />
