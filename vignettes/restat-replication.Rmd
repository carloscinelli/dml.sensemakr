...
# benchmarks at 1x for all covariates
sens.401k.bench <- sensemakr(dml.401k.plm, cf.y = 0.04, cf.d = 0.03,
                              bound_label = "Max match (3 years)",
...
# lower bound
plot(sens.401k.bench, which.bound = "lwr", lim.x = 0.18, col.contour = "blue")
add_bound_to_contour(bench.inc, kd = 1/4, which.bound = "lwr")

# upper bound
plot(sens.401k.bench, which.bound = "upr", lim.x = 0.18, col.contour = "blue")
add_bound_to_contour(bench.inc, kd = 1/4, which.bound = "upr")
