...
Here we reproduce the empirical example of  [Chernozhukov, V., Cinelli, C., Newey, W., Sharma A., and Syrgkanis, V. (2021). "Long Story Short: Omitted Variable Bias in Causal Machine Learning."](https://www.nber.org/papers/w30302) Our goal is to assess the sensitivity of of the estimate of the causal impact of 401(k) eligibility on net financial assets against potential uncontrolled confounding. 
